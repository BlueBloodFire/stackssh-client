...
import { TerminalPanelV2 } from '../components/TerminalPanelV2'
    ...
    <div className="w-screen h-screen flex flex-col overflow-hidden" style={{ backgroundColor: colors.bgPrimary }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          {terminalVisible ? (
            <TerminalPanelV2 onTerminalSessionChange={handleTerminalSessionChange} />
          ) : (
        ...
        {chatVisible && (
          <>
            ...
            <RightSidebarV2 width={chatWidth} activeTerminalSessionId={activeTerminalSessionId} />
          </>
        )}
      </div>
